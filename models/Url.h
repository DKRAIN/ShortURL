...
class Url
{
  public:
     ...
     */
    explicit Url(const drogon::orm::Row &r, const ssize_t indexOffset = 0) noexcept;

    /**
     * @brief constructor
     * @param pJson The json object to construct a new instance.
     */
    explicit Url(const Json::Value &pJson) noexcept(false);
     ...
     */
    Url(const Json::Value &pJson, const std::vector<std::string> &pMasqueradingVector) noexcept(false);
  ...
  private:
    friend drogon::orm::Mapper<Url>;
#ifdef __cpp_impl_coroutine
    friend drogon::orm::CoroMapper<Url>;
#endif
